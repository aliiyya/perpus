            ...
            <td width="500">
                ...
                <table border="1">
                    ...
                    <tbody>
                        <?php
                        include "koneksi.php";
                        $query = "SELECT * FROM meminjam, buku, anggota WHERE meminjam.id_anggota = anggota.id_anggota AND meminjam.kd_buku = buku.kd_buku AND meminjam.kembali = 1 ORDER BY id_pinjam";
                ...
                <table border="1">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT * FROM meminjam, buku, anggota WHERE meminjam.id_anggota = anggota.id_anggota AND meminjam.kd_buku = buku.kd_buku AND meminjam.kembali = 2 ORDER BY id_pinjam";
                        $sql = mysqli_query($koneksi, $query); // Menggunakan mysqli_query
                        $no = 1;
                        while ($data = mysqli_fetch_array($sql)) { // Menggunakan mysqli_fetch_array
                        ?>
